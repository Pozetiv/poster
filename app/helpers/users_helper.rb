module UsersHelper
  ...
  def to_vote_up(arg)
    ...
    set_class += 'text-success' if user_signed_in? && current_user.voted_up_on?(arg[:object])
  ...
  def to_vote_down(arg)
    ...
    set_class += 'text-danger' if user_signed_in? && current_user.voted_down_on?(arg[:object])
